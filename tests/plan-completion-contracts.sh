...
need "Version: 1.2.1-rc1" "$P/video-wall-and-live-broadcasting.php" version
...
for token in "class VWLB_Extensions" "class VWLB_Podcasts" "class VWLB_Observability" "class VWLB_Extended_REST" "class VWLB_Future_Intelligence" "class VWLB_Future_REST" "class VWLB_Future_Frontend"; do need "$token" "$P/includes" "$token"; done
