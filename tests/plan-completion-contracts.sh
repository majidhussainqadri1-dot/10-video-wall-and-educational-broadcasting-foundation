...
need "Version: 1.2.9-rc1" "$P/video-wall-and-live-broadcasting.php" version
...
for token in "class VWLB_Extensions" "class VWLB_Podcasts" "class VWLB_Observability" "class VWLB_Extended_REST" "class VWLB_Future_Intelligence" "class VWLB_Future_Safety" "class VWLB_Future_REST" "class VWLB_Future_Frontend" "class VWLB_R60_Final_Hardening"; do need "$token" "$P/includes" "$token"; done
