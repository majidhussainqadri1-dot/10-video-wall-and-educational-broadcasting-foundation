...
grep -F "Version: 1.2.8-rc1" "$PLUGIN/video-wall-and-live-broadcasting.php" >/dev/null || fail version
grep -F "define( 'VWLB_VERSION', '1.2.8-rc1' );" "$PLUGIN/video-wall-and-live-broadcasting.php" >/dev/null || fail constant
