...
ts=TEST.read_text()
checks='''\n# R20 — the corrected candidate, package builder and release workflow share one release identity.\nneed "Version: 1.2.3-rc1" "$P/video-wall-and-live-broadcasting.php" r20-runtime-version\nneed "video-wall-and-live-broadcasting-1.2.3-rc1.zip" "$ROOT/tools/build-package.sh" r20-build-version\nneed "file10-video-wall-live-1.2.3-rc1" "$ROOT/.github/workflows/file10-release.yml" r20-artifact-version\n'''
if 'r20-runtime-version' not in ts: TEST.write_text(ts+checks)
ls=LEDGER.read_text()
entry='''## R20 — DEFECT FIXED\nThe final fresh release-hygiene review found that the working corrective branch was explicitly the `v1.2.3-rc1` candidate, but runtime metadata, default package naming, release workflow artifact naming and the earlier release-identity regression contract still advertised `1.2.2-rc1`. Shipping the reviewed corrections under the prior candidate identity would make package/deployment parity evidence ambiguous. Runtime, deterministic builder, GitHub release QA artifact naming and regression expectations are now synchronized to `1.2.3-rc1`; schema versions remain unchanged because this corrective cycle did not introduce a new database schema.\n\n'''
