...
final class VWLB_State_Machine {
	private static $maps = array(
		'video'=>array('draft'=>array('uploading','review','removed'),'uploading'=>array('scanning','failed','removed'),'scanning'=>array('processing','quarantined','failed'),'processing'=>array('review','failed'),'review'=>array('scheduled','published','restricted','removed'),'scheduled'=>array('published','restricted','removed'),'published'=>array('restricted','removed'),'restricted'=>array('published','removed'),'failed'=>array('draft','removed')),
		'asset'=>array('initiated'=>array('uploaded','failed'),'uploaded'=>array('verified','quarantined','failed'),'verified'=>array('scanning','processing','ready','failed'),'scanning'=>array('processing','quarantined','failed'),'processing'=>array('ready','failed'),'failed'=>array('processing','deleted'),'quarantined'=>array('verified','deleted'),'ready'=>array('deleted')),
		'live'=>array('draft'=>array('scheduled','removed'),'scheduled'=>array('rehearsal','ready','restricted','removed'),'rehearsal'=>array('ready','scheduled','failed'),'ready'=>array('live','scheduled','failed'),'live'=>array('interrupted','ended','restricted'),'interrupted'=>array('live','ended','failed'),'ended'=>array('recording_processing','replay_review','replay_published','failed'),'recording_processing'=>array('replay_review','replay_published','failed'),'replay_review'=>array('replay_published','failed','restricted'),'replay_published'=>array('restricted','removed'),'restricted'=>array('scheduled','replay_published','removed'),'failed'=>array('scheduled','removed')),
