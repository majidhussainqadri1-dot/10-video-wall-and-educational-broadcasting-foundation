...
final class VWLB_Jobs {
	...
	public static function reconcile(){
		...
		$after=absint(get_option(self::LIVE_RECONCILE_CURSOR_OPTION,0));$wpdb->last_error='';$events=$wpdb->get_results($wpdb->prepare("SELECT * FROM ".VWLB_Helpers::table('live_events')." WHERE status IN ('scheduled','rehearsal','ready','live','interrupted') AND id>%d ORDER BY id ASC LIMIT 100",$after),ARRAY_A);
