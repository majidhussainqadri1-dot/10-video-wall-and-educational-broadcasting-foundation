...
$autoload = array(
	...
	'class-vwlb-future-intelligence.php', 'class-vwlb-future-safety.php', 'class-vwlb-review-hardening.php', 'class-vwlb-sequential-review-hardening.php', 'class-vwlb-r10-integrity.php', 'class-vwlb-r11-restore-guard.php', 'class-vwlb-r18-durability.php', 'class-vwlb-r20-retry-privacy.php', 'class-vwlb-r30-evidence-privacy.php', 'class-vwlb-r31-webhook-integrity.php', 'class-vwlb-r3-playback.php', 'class-vwlb-r4-migration-guard.php', 'class-vwlb-future-adapters.php', 'class-vwlb-future-rest.php', 'class-vwlb-future-frontend.php',
