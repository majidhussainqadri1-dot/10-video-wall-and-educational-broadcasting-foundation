...
foreach ( $autoload as $file ) { require_once VWLB_DIR . 'includes/' . $file; }
...
function vwlb_boot() {
	...
	VWLB_R10_Integrity::register(); VWLB_R11_Restore_Guard::register(); VWLB_R18_Durability::register(); VWLB_R20_Retry_Privacy::register(); VWLB_R30_Evidence_Privacy::register(); VWLB_R31_Webhook_Integrity::register(); VWLB_Sequential_Review_Hardening::register(); VWLB_R34_Frontend_Contract::register(); VWLB_R45_Upload_Durability::register(); VWLB_R46_Stream_Credential_Durability::register(); VWLB_R50_Privacy_Proof::register(); VWLB_R60_Final_Hardening::register(); VWLB_R64_Intelligence_Guard::register();
}
