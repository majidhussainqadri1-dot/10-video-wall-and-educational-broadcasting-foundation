# File 10 Release Candidate Manifest — 1.2.20-rc1

- Plugin folder: `video-wall-and-live-broadcasting`
- Plugin version: `1.2.20-rc1`
- Base schema: `1.1.0`
...
- Package target: `packages/video-wall-and-live-broadcasting-1.2.20-rc1.zip`
- Checksum target: same filename plus `.sha256`
- SBOM: `SBOM-1.2.20-rc1.json`
