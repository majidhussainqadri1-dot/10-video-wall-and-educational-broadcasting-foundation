# File 10 Release Candidate Manifest — 1.2.19-rc1

- Plugin folder: `video-wall-and-live-broadcasting`
- Plugin version: `1.2.19-rc1`
- Base schema: `1.1.0`
...
- Package target: `packages/video-wall-and-live-broadcasting-1.2.19-rc1.zip`
- Checksum target: same filename plus `.sha256`
- SBOM: `SBOM-1.2.19-rc1.json`
- Prior review boundary: R81–R100 closed at `1.2.11-rc1` on exact reviewed HEAD `9a2c317d664b3c0d56797afbf1934f6c55479aaa`.
- Current review boundary: R101–R120 sequential cycle; R101–R106 are QA-closed at their recorded exact reviewed heads. R107 review/freeze/correction is complete; final exact-head R107 release QA is pending and R108 must not begin until that gate is green.
...
- R107 correction candidate identity: `1.2.19-rc1`.
