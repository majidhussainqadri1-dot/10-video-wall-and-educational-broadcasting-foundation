# File 10 Release Candidate Manifest — 1.2.17-rc1

- Plugin folder: `video-wall-and-live-broadcasting`
- Plugin version: `1.2.17-rc1`
- Base schema: `1.1.0`
...
- Package target: `packages/video-wall-and-live-broadcasting-1.2.17-rc1.zip`
- Checksum target: same filename plus `.sha256`
- SBOM: `SBOM-1.2.17-rc1.json`
- Prior review boundary: R81–R100 closed at `1.2.11-rc1` on exact reviewed HEAD `9a2c317d664b3c0d56797afbf1934f6c55479aaa`.
- Current review boundary: R101–R120 sequential cycle; R101–R105 are QA-closed at their recorded exact reviewed heads. R106 review/freeze/correction is complete and its final exact-head release QA is pending; R107 must not begin until that gate is green.
